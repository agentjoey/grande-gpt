...
- **Next**: 先把 bootstrap/readiness 建模为内部 primitive，覆盖 npm/pnpm 的 lockfile identity、cache hit/miss、install failure 分类和 task/canonical verification 两种 consumer；不要先开放新 public MCP tool。
